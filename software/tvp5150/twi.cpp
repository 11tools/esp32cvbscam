...
void twi_device_write(unsigned char addr, unsigned char reg, unsigned char thedata)
{
          bool acktemp=1;
          twi_write_start();
          acktemp = twi_write_byte(addr);
          acktemp = twi_write_byte(reg);/*address*/
          acktemp = twi_write_byte(thedata);/*thedata*/;
          twi_write_stop();
}


unsigned char twi_device_read(unsigned char addr, unsigned char reg)
{         bool acktemp=1;
          unsigned char mydata;
           /*read a byte from mem*/
          twi_write_start();
          acktemp = twi_write_byte(addr);/*address*/

          acktemp = twi_write_byte(reg);
